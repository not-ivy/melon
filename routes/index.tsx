    ...
    <>
      ...
      <main className="p-4 w-screen h-screen flex justify-center items-center dark:(bg-gray-900 text-white)">
        <div>
          ...
          <a className="mx-auto flex items-center cursor-pointer select-none group" id="underline" href="https://github.com/not-ivy/melon" target="_blank">
            <span className="text-3xl font-light">A <span className="text-red-400">sweet</span> link shortener.</span>
            <button className="transition-colors ml-4 duration-300 ease-[cubic-bezier(0.55,0,1,0.45)] text-gray-700 group-hover:text-white" aria-label="View source code">
